...
namespace Prokl\CustomFrameworkExtensionsBundle\Extra;
 ...
 * @package LProkl\CustomFrameworkExtensionsBundle\Extra
 *
...
class DoctrineDbalExtension
{
    ...
    public function dbalLoad(array $config, ContainerBuilder $container)
    {
        ...
        if (!method_exists(
            SQLParserUtils::class,
            'getPositionalPlaceholderPositions'
        ) && method_exists(LoggerChain::class, 'addLogger')) {
    ...
    protected function loadDbalConnection($name, array $connection, ContainerBuilder $container)
    {
        ...
        $def = $container
            ->setDefinition(
                ...
                new ChildDefinition('doctrine.dbal.connection')
            )
            ->setPublic(true)
            ->setArguments([
                $options,
        ...
        if (isset($options['shards'])) {
            $shardManagerDefinition = new Definition(
                $options['shardManagerClass'],
