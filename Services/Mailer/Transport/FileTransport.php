...
namespace Prokl\CustomFrameworkExtensionsBundle\Services\Mailer\Transport;
...
/**
 * Class FileTransport
 * @package Prokl\CustomFrameworkExtensionsBundle\Services\Mailer\Transport
 *
 * @since 02.03.2021
 *
...
class FileTransport extends AbstractTransport
{
    ...
    /**
     * @var LoggerInterface|null $logger Логгер.
     */
    private $logger;
